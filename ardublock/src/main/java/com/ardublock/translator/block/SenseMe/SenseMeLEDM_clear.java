...
public class SenseMeLEDM_clear extends TranslatorBlock {

	public SenseMeLEDM_clear (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
